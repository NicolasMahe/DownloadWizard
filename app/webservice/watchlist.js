...
.factory('Watchlist', ['$http', function($http) {
    return {
    	update: function(dataToPost, successFunction, errorFunction) {
	    	$http.post('phparse/?page=watchlist&action=update', dataToPost).
    	...
    	add: function(dataToPost, successFunction, errorFunction) {
	    	$http.post('phparse/?page=watchlist&action=add', dataToPost).
			success(function(data, status, headers, config) {
				if(successFunction)
					successFunction(data);
			})
    	...
    	get: function(id, successFunction, errorFunction) {
	    	$http.get('phparse/?page=watchlist&action=get&id='+id).
			success(function(data, status, headers, config) {
				if(successFunction)
					successFunction(data);
			})
    	...
    	getAll: function(successFunction, errorFunction) {
	    	$http.get('phparse/?page=watchlist&action=get').
			success(function(data, status, headers, config) {
				if(successFunction)
					successFunction(data);
			})
    	...
    	delete: function(id, successFunction, errorFunction) {
	    	$http.get('phparse/?page=watchlist&action=delete&id='+id).
                    success(function(data, status, headers, config) {
                            if(successFunction)
                                    successFunction(data);
                    })
